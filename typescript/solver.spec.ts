...
import { allPossibleHouses, englishmanLivesInRedHouse } from './solver';

describe('allPossibleHouses should', () => {
	it('create one item per possible combinations', () => {
		var result = allPossibleHouses();
...
describe('englishmanLivesInRedHouse should', () => {
	it('return true if house is valid', () => {
	});
});
